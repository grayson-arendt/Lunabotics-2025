...
/**
 * @brief Rotates linear acceleration and angular velocity in an IMU message for the D455 camera.
  ...
  public:
    ...
    IMURotator() : Node("imu_rotator")
    {
        ...
        t265_subscriber_ = this->create_subscription<sensor_msgs::msg::Imu>(
            "t265/imu", 10, std::bind(&IMURotator::d455_callback, this, std::placeholders::_1));

        d455_publisher_ = this->create_publisher<sensor_msgs::msg::Imu>("imu/data_raw", 10);
        t265_publisher_ = this->create_publisher<sensor_msgs::msg::Imu>("imu/data_raw2", 10);
    }
