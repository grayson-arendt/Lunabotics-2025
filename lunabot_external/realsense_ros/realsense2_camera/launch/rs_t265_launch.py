...
local_parameters = [{'name': 'device_type', 'default': 't265', 'description': 'choose device by type'},
                    {'name': 'camera_name', 'default': 't265', 'description': 'camera namespace'},
                    {'name': 'camera_namespace', 'default': 't265', 'description': 'camera namespace'},
                    ...
                    {'name': 'publish_odom_tf','default': 'false', 'description': 'publish odom tf'},
                   ]
